...
- Draft transcript uploads warm every distinct avatar hash used by referenced users, including reaction users and per-message or referenced-message webhook identity variants.
